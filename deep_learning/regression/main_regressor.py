...
# best_parameters.values['learning_rate'] = 0.0001
...
history = model.fit(X_train, y_train, batch_size=16, callbacks=callbacks, verbose=1, epochs=100, validation_split=0.2)
...
plt.xlim([0, 0.5])
plt.ylim([0, 0.5])
plt.xlabel('Observed quality [-]', fontsize=12)
